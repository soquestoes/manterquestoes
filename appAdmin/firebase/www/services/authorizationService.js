angular.module('App').factory('authorizationService', 
        function(FURL, $firebaseAuth, $firebaseArray, $firebaseObject, utilityService) {
    ...
    logout: function() {
      auth.$unauth();
		//	console.log("Usuário saíu da sessão.");
    },
		...
		resetpassword: function(user) {
			return auth.$resetPassword({
				  email: user.email
					...
					utilityService.alertshow("Sucesso.","Uma senha temporária foi enviada para seu email.");
				  //console.log("Password reset email sent successfully!");
				}).catch(function(error) {
					utilityService.errMessage(error);
